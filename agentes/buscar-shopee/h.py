...
import pandas as pd
from openpyxl.styles import Font, PatternFill, Border, Alignment, Side  # Added Side import
import pygame  # Importando pygame para controle de eventos
import sys  # Importando sys para sair do programa
